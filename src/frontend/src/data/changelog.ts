...
export const CHANGELOG: ChangelogVersion[] = [
  {
    ...
    eintraege: [
      ...
      { typ: 'fix', text: 'Rechnungen – Finalisieren mit einem Rechnungsdatum in der Zukunft wird jetzt verweigert (§14 Abs. 4 UStG: das Ausstellungsdatum muss dem tatsächlichen Tag der Rechnungsstellung entsprechen). Im Entwurf bleibt ein Zukunftsdatum weiterhin möglich, beim Speichern erscheint dazu ein Hinweis (Issue #253).' },
    ],
  },
  {
    version: 'v0.4.12',
